...
while (True):
    ...
    for face in faces:
        ...
        # cv2.circle(image, (left_eye, y1), 60, (0, 0, 0), -1)
        # cv2.circle(image, (right_eye, y1), 60, (0, 0, 0), -1)
        # cv2.circle(image, (left_eye, y1), 20, (255, 255, 255), -1)
        # cv2.circle(image, (right_eye, y1), 20, (255, 255, 255), -1)
